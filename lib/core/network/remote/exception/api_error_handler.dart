import 'package:daraz_app/core/base_response/api_response.dart';
  ...
  static ApiResponse getErrorResponse({
    ...
    if (error is Exception) {
      if (error is DioException) {
        ...
        return ApiResponse(response: error.response, message: errorDescription);
      }
    }

    return ApiResponse(response: null, message: errorDescription);
  }
