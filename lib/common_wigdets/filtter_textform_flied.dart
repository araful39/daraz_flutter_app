...
class FiltterTextformFlied extends StatefulWidget {
  final String label;
  ...
  @override
  State<FiltterTextformFlied> createState() => _FiltterTextformFliedState();
}

class _FiltterTextformFliedState extends State<FiltterTextformFlied> {
  ...
  @override
  void didUpdateWidget(FiltterTextformFlied oldWidget) {
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(color: AppColors.cA5A5A5, width: 1),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8.r),
              borderSide: BorderSide(color: AppColors.cA5A5A5, width: 1.2),
            ),
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8.r),
              borderSide: BorderSide(color: AppColors.cA5A5A5),
            ),
          ),
        ),
      ],
